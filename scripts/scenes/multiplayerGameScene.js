...
export const multiplayerGameScene = new Scene([
    ...
    if (radiated) {
        playerColorColumns[0] = getRandomRGB();
        playerColorColumns[1] = getRandomRGB();
        playerColorColumns[2] = getRandomRGB();

        enemyColorColumns[0] = getRandomRGB();
        enemyColorColumns[1] = getRandomRGB();
        enemyColorColumns[2] = getRandomRGB();
        console.log("IT BURRRRNS");
    }
